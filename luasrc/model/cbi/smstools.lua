...
m:section(SimpleSection).template  = "smstools/smstools_status"

s = m:section(TypedSection, "smstools")
s.anonymous = true
...
s:tab("smsc", translate("message center"))
...
s:tab("address", translate("address list"))
